...
def single_gpu_train():
    ...
    criterion_g_adv = torch.nn.BCELoss()  # need separate criterion to carry loss only through Gs?
    ...
    for epoch in range(100000):
        for i, data in enumerate(train_data_loader):
            ...
            G1_adv_loss = criterion_g_adv(prob_g1_pred, REAL_t)
            ...
            G2_adv_loss = criterion_g_adv(prob_g2_pred, REAL_t)
